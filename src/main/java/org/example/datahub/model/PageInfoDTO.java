...
public class PageInfoDTO {
  ...
  */
  ...
  public PageInfoDTO pageNum(Integer pageNum) {
  ...
  */
  ...
  @Schema(name = "page_num", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public PageInfoDTO pageSize(Integer pageSize) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalPages, pageInfo.totalPages) &&
        Objects.equals(this.pageNum, pageInfo.pageNum) &&
        Objects.equals(this.pageSize, pageInfo.pageSize);
  }

  @Override
  public int hashCode() {
    return Objects.hash(totalPages, pageNum, pageSize);
  }
